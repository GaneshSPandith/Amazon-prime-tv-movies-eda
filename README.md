Title: Amazon Prime TV Shows and Movies – Exploratory Data Analysis (EDA)
Project Type: Exploratory Data Analysis (EDA)
Contribution: Individual

Project Overview -
This project explores the Amazon Prime Video catalog for the US region using Exploratory Data Analysis (EDA). The goal is to understand what kinds of titles are available on the platform, how they are rated, and how factors like genre, country, and creators influence the catalog.

Business Objective -
Use historical title and credits data to:
